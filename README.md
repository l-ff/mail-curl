...
| `twenty_two_do` | 通过 22.do Web 页面流程登录邮箱并解析 HTML 收件箱/邮件详情 | 设置 `TWENTY_TWO_DO_ENABLED=1` |
...
| `TWENTY_TWO_DO_ENABLED` | 空 | 设置为 `1` 后启用 `twenty_two_do` provider |
| `TWENTY_TWO_DO_BASE_URL` | `https://22.do` | `twenty_two_do` 上游地址 |
| `TWENTY_TWO_DO_TIMEOUT_MS` | `20000` | `twenty_two_do` 请求超时时间 |
| `TWENTY_TWO_DO_LANGUAGE` | `en-US` | 登录 22.do 邮箱时传给页面接口的语言 |
